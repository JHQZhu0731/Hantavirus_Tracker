...
STRINGS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "svg_head":        "ALL DISEMBARKED",
        "svg_split":       "SPLIT",
        "svg_outcomes":    "OUTCOMES",
        "svg_split_sub":   "Contacts / Cases",
        "contacts_lbl":    "Contacts",
        "contacts_p1":     "Repatriated — 19+ countries",
        "contacts_p2":     "42-day self-monitoring",
        "cluster_lbl":     "Cluster",
        "cluster_p1":      "Predict: ANDV",
        "monitor_lbl":     "Under monitoring",
        "monitor_p1":      "No new infections to date",
        "monitor_p2":      "as of 15 May 2026",
        "pax_lbl":         "pax",
        "crew_lbl":        "crew",
        "leg_pax":         "Passengers",
        "leg_crew":        "Crew",
        ...
        "snap_persons":    "Persons (all disembarked 11 May)",
    ...
    "zh": {
        ...
        "svg_split":       "分组",
        "svg_outcomes":    "结局",
        "svg_split_sub":   "接触者 / 病例",
        "contacts_lbl":    "接触者",
        "contacts_p1":     "遣返至19+国家",
        "contacts_p2":     "42天自我监测",
        "cluster_lbl":     "病例群",
        "cluster_p1":      "预测：安第斯病毒",
        "monitor_lbl":     "监测中",
        "monitor_p1":      "迄今无新增感染",
        "monitor_p2":      "截至2026年5月15日",
        "pax_lbl":         "乘客",
        "crew_lbl":        "船员",
        "leg_pax":         "乘客",
        "leg_crew":        "船员",
...
def build_sankey_svg(sk: dict, esc, S: dict, lang: str = "en") -> str:
    ...
    lbls.append(block(x0r + 16, (y_c0 + y_k1) / 2, [
        ...
        (f"11 May 2026 · Tenerife",                        "700", "#57068c", "10"),
        (f"{pax} {pax_word} \u00b7 {crew} {crew_word}",   "400", "#444",    "9"),
    ...
    # ── column headers ────────────────────────────────────────────────────────
    col_info = [
        (x0l + BAR/2, S["svg_head"],     f"n = {ship} · 11 May 2026"),
        (x1l + BAR/2, S["svg_split"],    S["svg_split_sub"]),
        (x2l + BAR/2, S["svg_outcomes"], "as of 15 May 2026"),
    ]
    hdrs = []
